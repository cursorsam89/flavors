  ...
  Widget build(BuildContext context) {
    final GoRouter router = GoRouter(
      ...
      routes: <RouteBase>[
        ...
        GoRoute(
          path: '/dashboard',
          builder: (BuildContext c, GoRouterState s) => const DashboardPage(),
        ),
        GoRoute(
          path: '/soroban',
          builder: (BuildContext c, GoRouterState s) => const SorobanPage(),
        ),
        GoRoute(
          path: '/more',
          builder: (BuildContext c, GoRouterState s) => const MorePage(),
        ),
      ],
    );
      ...
      builder: (BuildContext context, _) {
        return ChangeNotifierProvider<SettingsController>.value(
          ...
          child: MaterialApp.router(
            onGenerateTitle: (BuildContext ctx) => FlavorConfig.isStudent
                ? AppLocalizations.of(ctx).appTitleKids
                : AppLocalizations.of(ctx).appTitleTutor,
            routerConfig: router,
